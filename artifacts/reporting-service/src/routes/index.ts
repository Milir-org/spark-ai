...
router.get("/dashboard/summary", (_req, res) => {
  return res.json({
    activeCampaigns: 7, totalSpend: 142850, leadsGenerated: 3247,
    conversionRate: 4.2, pendingApprovals: 8, aiOpportunities: 14,
    revenueInfluenced: 892000, budgetUsed: 142850, budgetTotal: 200000,
  });
});
