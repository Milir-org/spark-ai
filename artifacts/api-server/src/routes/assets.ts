...
router.post("/assets/generate", (req, res) => {
  ...
  const generated = [
    { id: 200, type: "ad_copy", title: "Google Search Ad — Primary", content: "Headline: Supercharge Campaign ROI with AI\nDescription: AI-powered campaign planning for ambitious marketing teams. Start seeing results in 14 days. Free trial — no credit card.", status: "draft", approvalStatus: "pending", createdBy: 1, organizationId: DEFAULT_ORG, campaignId: req.body.campaignId, campaignName: null, createdAt: new Date().toISOString() },
    { id: 201, type: "social_post", title: "LinkedIn Launch Post", content: "Something big is here. We just launched a multi-channel campaign with SPARK AI — from brief to blueprint in 60 seconds. Here's what the first 7 days looked like... (thread below) 🧵", status: "draft", approvalStatus: "pending", createdBy: 1, organizationId: DEFAULT_ORG, campaignId: req.body.campaignId, campaignName: null, createdAt: new Date().toISOString() },
    { id: 202, type: "email_copy", title: "Launch Email — Subject Line A", content: "Subject: We've been working on something for you\n\nHi [Name],\n\nFor the past 3 months, we've been building the marketing command centre we always wished we had.\n\nToday, we're launching it.\n\nSPARK AI...", status: "draft", approvalStatus: "pending", createdBy: 1, organizationId: DEFAULT_ORG, campaignId: req.body.campaignId, campaignName: null, createdAt: new Date().toISOString() },
    { id: 203, type: "landing_page_copy", title: "Landing Page — Hero Section", content: "Headline: Your AI Marketing Command Centre\nSubheadline: Plan campaigns, activate channels, approve decisions, and report results — all in one intelligent platform.\nCTA: Start Your Free Trial", status: "draft", approvalStatus: "pending", createdBy: 1, organizationId: DEFAULT_ORG, campaignId: req.body.campaignId, campaignName: null, createdAt: new Date().toISOString() },
    { id: 204, type: "whatsapp_message", title: "WhatsApp Follow-Up — Day 1", content: "Hi [Name], thanks for your interest in SPARK AI. Quick question — what's the biggest campaign challenge you're facing right now? I'd love to show you how we solve it.", status: "draft", approvalStatus: "pending", createdBy: 1, organizationId: DEFAULT_ORG, campaignId: req.body.campaignId, campaignName: null, createdAt: new Date().toISOString() },
  ];
